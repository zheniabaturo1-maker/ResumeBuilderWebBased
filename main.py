...
AUTUMN_COURSES_2025 = []
SPRING_COURSES_2026 = []
AUTUMN_COURSES_2026 = ['ПрИнж_ТВМС', 'Мат_стат_ПМКАИБАС', 'РКИиП_ТВиМС', 'NN_бакалавриат', 'Математический анализ (Часть 1)', 'Математический анализ (Часть 2)', 'Машинное обучение']
    ...
    try:
        ...
        teacher_info = {
            ...
            'Карнаухова Ольга Александровна': {'avatar': 'https://img.icons8.com/color/96/000000/user-female-circle--v1.png',
                                      ...
                                      'education': 'Кандидат педагогических наук', 'experience': '15 лет преподавания',
                                      'placeOfWork': 'Кафедра прикладной математики и анализа данных, доцент',
            ...
            'Кустицкая Татьяна Алексеевна': {
                ...
                'education': 'Кандидат физико-математических наук', 'experience': '15 лет преподавания',
                'placeOfWork': 'Кафедра прикладной математики и анализа данных, доцент',
                'phone': '+7 (391) 291-27-90', 'email': 'tkustitskaya@sfu-kras.ru'},
        }
