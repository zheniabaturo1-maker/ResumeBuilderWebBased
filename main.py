...
AUTUMN_COURSES_2025 = []
SPRING_COURSES_2026 = []
AUTUMN_COURSES_2026 = ['ПрИнж_ТВМС', 'Мат_стат_ПМКАИБАС', 'РКИиП_ТВиМС', 'NN_бакалавриат', 'Математический анализ (Часть 1)', 'Математический анализ (Часть 2)']
...
teacher_dict = {
    ...
    'Математический анализ (Часть 2)': 'Карнаухова Ольга Александровна',
}
TEACHER_CREDENTIALS = {
    ...
    try:
        ...
        teacher_info = {
            ...
            'Карнаухова Ольга Александровна': {'avatar': 'https://img.icons8.com/color/96/000000/user-female-circle--v1.png',
                                      'position': 'Преподаватель математической анализа',
